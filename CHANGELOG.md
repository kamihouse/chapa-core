...
## [0.10.1](https://gitlab.fretebras.com.br/fretepago/payments/core/compare/v0.11.0...v0.10.1) (2023-09-13)

### Features

* Add new validators ([cf6cf3](https://gitlab.fretebras.com.br/fretepago/payments/core/commit/cf6cf3e8af0726e212371c261388263f94cc2165), [24663f](https://gitlab.fretebras.com.br/fretepago/payments/core/commit/24663fbb65807009b5e581ae11263cff9b4066a2))
* Enabled distributed bus and breakchange - refactoring event dispatcher. ([ff21a2](https://gitlab.fretebras.com.br/fretepago/payments/core/commit/ff21a250d6d562362013f3da5427f46e2eecec3c))

##### Domain/ Event

* :zap: Improved event class serialization ([f64835](https://gitlab.fretebras.com.br/fretepago/payments/core/commit/f64835d319204d0a80a652061d24d32571536729))
...
* :hammer: simplify json conversion logic ([1582c6](https://gitlab.fretebras.com.br/fretepago/payments/core/commit/1582c684c8d6e163aa7f18fd3d3d89ab01bb5aeb))
...
## [0.9.5](https://gitlab.fretebras.com.br/fretepago/payments/core/compare/v0.9.4...v0.9.5) (2023-07-19)

### Features

* :sparkles: implement json serialize interface on domain event ([056ca0](https://gitlab.fretebras.com.br/fretepago/payments/core/commit/056ca0f615e8b610a572c9f76486559c1be067c3))


---

## [0.9.4](https://gitlab.fretebras.com.br/fretepago/payments/core/compare/v0.9.3...v0.9.4) (2023-07-19)

### Features

* Added target typehint for message consumer ([44f7ea](https://gitlab.fretebras.com.br/fretepago/payments/core/commit/44f7ea2a8efa568cf935c3c80ed860fb00e8c15c))

### Chores

* Increase coding standart rule ([5d8434](https://gitlab.fretebras.com.br/fretepago/payments/core/commit/5d84342019b75953b8f490c92ca10825a2c46dd5))


---

## [0.9.3](https://gitlab.fretebras.com.br/fretepago/payments/core/compare/v0.9.2...v0.9.3) (2023-07-14)

### Features

* Added ecotone kafka retry configuration ([3c2f7b](https://gitlab.fretebras.com.br/fretepago/payments/core/commit/3c2f7bbc70e3e29e57098f139223eac8d918e562))

### Bug Fixes

* Resolved SchemaVersion not set ([fafcde](https://gitlab.fretebras.com.br/fretepago/payments/core/commit/fafcdece5d979ef45580d06fdfeb4bdf0f379cb1))
